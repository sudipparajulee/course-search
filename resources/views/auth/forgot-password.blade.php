...
<head>
    ...
    <title>Forgot Password — StudyAide</title>
...
<div class="w-full max-w-md">
    ...
    <div class="overflow-hidden rounded-2xl bg-white shadow-[0_8px_40px_rgba(26,58,92,0.12)] ring-1 ring-[#1a3a5c]/8">
        ...
        <div class="px-8 py-10">
            <h1 class="text-2xl font-bold text-[#1a3a5c]">Forgot password?</h1>
            ...
            @if (session('status'))
                <div class="mt-6 rounded-xl border border-green-100 bg-green-50 p-4 text-sm text-green-700">
                    {{ session('status') }}
                </div>
            @endif
            ...
            <p class="mt-6 text-center text-sm text-slate-500">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-[#2ca5b8] hover:text-[#1a3a5c] transition">Back to login</a>
            </p>
        </div>
    </div>
