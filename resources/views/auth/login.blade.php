...
<div class="w-full max-w-md">
    ...
    <div class="overflow-hidden rounded-2xl bg-white shadow-[0_8px_40px_rgba(26,58,92,0.12)] ring-1 ring-[#1a3a5c]/8">
        ...
        <div class="px-8 py-10">
            <h1 class="text-2xl font-bold text-[#1a3a5c]">Welcome back</h1>
            <p class="mt-1 text-sm text-slate-500">Sign in to your StudyAide account</p>
            ...
            @if (session('status'))
                <div class="mt-4 rounded-xl border border-green-100 bg-green-50 p-4 text-sm text-green-700">
                    {{ session('status') }}
                </div>
            @endif
                ...
                <div>
                    ...
                    @if (Route::has('password.request'))
                        <div class="mt-2 text-right">
                            <a href="{{ route('password.request') }}" class="text-xs font-medium text-[#2ca5b8] hover:text-[#1a3a5c] transition">Forgot password?</a>
                        </div>
                    @endif
                </div>
            ...
            <p class="mt-6 text-center text-sm text-slate-500">
                ...
                <a href="{{ route('register') }}" class="font-semibold text-[#2ca5b8] hover:text-[#1a3a5c] transition">Create one free</a>
            </p>
        </div>
    </div>
